...
async def connect_to_db():
    ...
    try:
        ...
        print("[INFO] Push notification database connection pool created successfully.")
    except Exception as e:
        print(
            f"[ERROR] Failed to create push notification database connection pool: {e}"
        )
        raise
...
async def close_db_connection():
    ...
    if pool:
        await pool.close()
        print("[INFO] Push notification database connection pool closed.")
